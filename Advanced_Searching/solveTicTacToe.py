...
class TicTacToeAgent():
    ...
    def get_boards_value(self, boards):
        board_A = self.get_board_state(boards[0])
        board_B = self.get_board_state(boards[1])
        board_C = self.get_board_state(boards[2])
    ...
    def evaluation_function(self, gameState, gameRules):
        ...
        result = self.get_boards_value(gameState.boards)
        if result in self.win_states:
            return -99999
        else:
            return 99999

    def max_value(self, gameState, gameRules, depth):
        if gameRules.isGameOver(gameState.boards) or depth == self.search_depth:
            return (self.evaluation_function(gameState, gameRules), None)

        value = float('-inf')
        actions = gameState.getLegalActions(gameRules)
        for action in actions:
            successor_state = gameState.generateSuccessor(action)
            score = self.min_value(successor_state, gameRules, depth)[0]
            if score >= value:
                value = score
                max_action = action
    ...
    def min_value(self, gameState, gameRules, depth):
        if gameRules.isGameOver(gameState.boards):
            return (self.evaluation_function(gameState, gameRules), None)
        ...
        for action in actions:
            successor_state = gameState.generateSuccessor(action)
            score = self.max_value(successor_state, gameRules, depth+1)[0]
            if score <= value:
                value = score
                min_action = action
    ...
    def rotate_90(self, board):
        return np.array(board).reshape((3,3)).T.reshape((1,-1)).tolist()[0]

    def flip(self, board, mode):
        if mode == 'lr':
            return np.fliplr(np.array(board).reshape((3,3))).reshape((1,-1)).tolist()[0]
        elif mode == 'ud':
            return np.flipud(np.array(board).reshape((3,3))).reshape((1,-1)).tolist()[0]

    def get_board_state(self, board):
        test_board = copy.deepcopy(board)
        
        for rotate in range(4):
            test_board = self.rotate_90(test_board)
            flip_board = copy.deepcopy(test_board)

            for f in range(3):
                if f == 1:
                    flip_board = self.flip(flip_board, 'lr')
                elif f == 2:
                    flip_board = self.flip(flip_board, 'ud')

                if flip_board == [False,False,False,False,False,False,False,False,False]:
                    return c
                elif flip_board == [False,False,False,False,True,False,False,False,False]:
                    return c**2
                elif flip_board == [True,True,False,False,False,False,False,False,False]:
                    return a*d
                elif flip_board == [True,False,True,False,False,False,False,False,False]:
                    return b
                elif flip_board == [True,False,False,False,True,False,False,False,False]:
                    return b
                elif flip_board == [True,False,False,False,False,True,False,False,False]:
                    return b
                elif flip_board == [True,False,False,False,False,False,False,False,True]:
                    return a
                elif flip_board == [False,True,False,True,False,False,False,False,False]:
                    return a
                elif flip_board == [False,True,False,False,True,False,False,False,False]:
                    return b
                elif flip_board == [False,True,False,False,False,False,False,True,False]:
                    return a
                elif flip_board == [True,True,False,True,False,False,False,False,False]:
                    return b
                elif flip_board == [True,True,False,False,True,False,False,False,False]:
                    return a*b
                elif flip_board == [True,True,False,False,False,True,False,False,False]:
                    return d
                elif flip_board == [True,True,False,False,False,False,True,False,False]:
                    return a
                elif flip_board == [True,True,False,False,False,False,False,True,False]:
                    return d
                elif flip_board == [True,True,False,False,False,False,False,False,True]:
                    return d
                elif flip_board == [True,False,True,False,True,False,False,False,False]:
                    return a
                elif flip_board == [True,False,True,False,False,False,True,False,False]:
                    return a*b
                elif flip_board == [True,False,True,False,False,False,False,True,False]:
                    return a
                elif flip_board == [True,False,False,False,True,True,False,False,False]:
                    return a
                elif flip_board == [False,True,False,True,True,False,False,False,False]:
                    return a*b
                elif flip_board == [False,True,False,True,False,True,False,False,False]:
                    return b
                elif flip_board == [True,True,False,True,True,False,False,False,False]:
                    return a
                elif flip_board == [True,True,False,True,False,True,False,False,False]:
                    return a
                elif flip_board == [True,True,False,True,False,False,False,False,True]:
                    return a
                elif flip_board == [True,True,False,False,True,True,False,False,False]:
                    return b
                elif flip_board == [True,True,False,False,True,False,True,False,False]:
                    return b
                elif flip_board == [True,True,False,False,False,True,True,False,False]:
                    return b
                elif flip_board == [True,True,False,False,False,True,False,True,False]:
                    return a*b
                elif flip_board == [True,True,False,False,False,True,False,False,True]:
                    return a*b
                elif flip_board == [True,True,False,False,False,False,True,True,False]:
                    return b
                elif flip_board == [True,True,False,False,False,False,True,False,True]:
                    return b
                elif flip_board == [True,True,False,False,False,False,False,True,True]:
                    return a
                elif flip_board == [True,False,True,False,True,False,False,True,False]:
                    return b
                elif flip_board == [True,False,True,False,False,False,True,False,True]:
                    return a
                elif flip_board == [True,False,False,False,True,True,False,True,False]:
                    return b
                elif flip_board == [False,True,False,True,False,True,False,True,False]:
                    return a
                elif flip_board == [True,True,False,True,False,True,False,True,False]:
                    return b
                elif flip_board == [True,True,False,True,False,True,False,False,True]:
                    return b
                elif flip_board == [True,True,False,False,True,True,True,False,False]:
                    return a
                elif flip_board == [True,True,False,False,False,True,True,True,False]:
                    return a
                elif flip_board == [True,True,False,False,False,True,True,False,True]:
                    return a
                elif flip_board == [True,True,False,True,False,True,False,True,True]:
                    return a
